...
\begin{frame}[fragile]{\Ctitle}{\stitle}
	\begin{block}{Proriété d'équilibre des arbres rouge-noirs}
		...
		\end{itemize}
		\onslide<4->{\textcolor{gray}{Pour démontrer ces inégalités, on procède par induction structurelle sur un arbre bicolore $t$ en effectuant une disjonction de cas sur la couleur de la racine.\\}}
		\onslide<4->{\textcolor{blue}{Conséquence : les arbres rouge-noir forment un ensemble d'arbres équilibrés.}}
	\end{block}
...
\begin{frame}[fragile]{\Ctitle}{\stitle}
	...
	\begin{itemize}
		...
		\item<5-> \textcolor{blue}{Acyclique}: il n'existe pas de cycle dans l'arbre, c'est à dire qu'il n'existe pas de suite de noeuds $x_1, \dots, x_n$ tels que $\{x_1,x_2\}, \{x_2,x_3\}, \dots, \{x_{n-1},x_n\}, \{x_n,x_1\} \in A$.
	\end{itemize}
	\onslide<6->{\textcolor{BrickRed}{\small \danger \;} On peut choisir n'importe quel noeud comme racine.}
	\end{block}
\end{frame}
