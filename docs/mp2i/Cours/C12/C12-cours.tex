	...
	\begin{block}{Exemple d'implémentation}
		\begin{itemize}
			\item<1-> Parcours préfixe en C (affichage des étiquettes)
				\onslide<2->{\inputpartC{\SPATH/arbres_binaires.c}{}{\footnotesize}{98}{106}}
...
\begin{frame}[fragile]{\Ctitle}{\stitle}
	\begin{block}{Implémentation en OCaml}
		En OCaml, la capacité du tableau étant accessible (avec \mintinline{ocaml}{Array.length}) on se contente de garder la taille effective dans un champ mutable
