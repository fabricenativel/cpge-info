...
\begin{frame}[fragile]{\Ctitle}{\stitle}
	\begin{block}{Type structuré en C}
		...
		\onslide<3->{\inputpartC{\SPATH/arbres_binaires.c}{}{}{6}{13}}
	\end{block}
\end{frame}
...
\begin{frame}[fragile]{\Ctitle}{\stitle}
	\begin{block}{Création d'un arbre}
		...
		\onslide<3>{\inputpartC{\SPATH/arbres_binaires.c}{}{}{17}{24}}
	\end{block}
\end{frame}
	...
	\begin{exampleblock}{Exemple}
		\begin{enumerate}
			...
			\item<2-> Ecrire la fonction qui calcule le nombre de noeuds d'un arbre binaire.
				\onslide<3->{\inputpartC{\SPATH/arbres_binaires.c}{}{}{26}{33}}
		\end{enumerate}
	\end{exampleblock}
\end{frame}
...
\begin{frame}[fragile]{\Ctitle}{\stitle}
	\begin{block}{Type structuré en OCaml}
		...
		\onslide<4->{\inputpartOCaml{\SPATH/arbres_binaires.ml}{}{}{1}{3}}
	\end{block}
	...
	\begin{block}{Exemples d'implémentation}
		\begin{itemize}
			\item<1-> Parcours préfixe en C (affichage des étiquettes)
				\onslide<2->{\inputpartC{\SPATH/arbres_binaires.c}{}{\footnotesize}{97}{105}}
			\item<3-> Parcours infixe en OCaml (affichage des étiquettes)
				\onslide<4->{\inputpartOCaml{\SPATH/arbres_binaires.ml}{}{\footnotesize}{56}{59}}
		\end{itemize}
	\end{block}
\end{frame}
...
\begin{frame}[fragile]{\Ctitle}{\stitle}
	\begin{block}{Implémentation des tableaux associatifs}
		\begin{itemize}
			\item<1-> Si l'ensemble des clé est ordonné, on peut implémenter les tableaux associatifs en utilisant une famille d'arbre binaire équilibré. Chaque noeud de l'arbre contient alors une information supplémentaire (sa valeur) en plus de la clé associée.
...
\begin{frame}{\Ctitle}{\stitle}
	\begin{block}{Implémentation en C}
		...
		\inputpartC{\SPATH/tas.c}{\small}{}{6}{12}
	\end{block}
\end{frame}
...
\begin{frame}[fragile]{\Ctitle}{\stitle}
	\begin{block}{Implémentation en OCaml}
		...
		\onslide<2->{\inputpartOCaml{\SPATH/tas.ml}{}{}{1}{1}}
		\onslide<3->{On utilise ici un tableau contenant des entiers, mais en OCaml, on pourrait facilement utiliser un type option \mintinline{ocaml}{'a} :}
		\onslide<4->{\inputpartOCaml{\SPATH/tas.ml}{}{}{3}{3}}
		\onslide<5->{De façon à instancier ce type lors de la création du tas :}
		\onslide<6->{\inputpartOCaml{\SPATH/tas.ml}{}{}{5}{6}}
	\end{block}
\end{frame}
...
\begin{frame}[fragile]{\Ctitle}{\stitle}
	\begin{block}{Implémentation : percolation vers le haut en C}
		\inputpartC{\SPATH/tas.c}{}{\footnotesize}{46}{61}
	\end{block}
\end{frame}

\begin{frame}[fragile]{\Ctitle}{\stitle}
	\begin{block}{Implémentation : percolation vers le bas en OCaml}
		\inputpartOCaml{\SPATH/tas.ml}{}{\footnotesize}{33}{48}
	\end{block}
\end{frame}
