...
\begin{frame}{\Ctitle}{\stitle}
	\begin{block}{le type \textcolor{yellow}{\tt list}}
		\begin{itemize}
			\item<1-> Le type \kw{list} est prédifini en OCaml et permet de représenter des listes de valeurs \textcolor{BrickRed}{de même type} et \textcolor{BrickRed}{non mutables}.
