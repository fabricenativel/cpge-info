...
\begin{frame}{\Ctitle}{\stitle}
	\begin{block}{Algorithme de Boyer-Moore-Hoorspool}
		...
		\begin{itemize}
			\item<2-> Si le caractère est présent dans le motif alors l'indice de sa dernière occurrence 
	...
	\onslide<4->{
		\begin{exampleblock}{Exemple}
			\begin{enumerate}
				\item<4-> Construire la table de décalage du motif "{\tt deux}"
				\item<5-> Simuler le fonction de l'algorithme de Boyer-Moore-Hoorspool pour recherche ce motif dans le chaine " 
			\end{enumerate}
