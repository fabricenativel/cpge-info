...
\begin{frame}{\Ctitle}{\stitle}
	\begin{block}{Définitions}
		...
		\begin{itemize}
			\item<1-> Les sommets \kw{E} et \kw{S} représentent l'entrée et la sorties
...
\begin{frame}{\Ctitle}{\stitle}
	...
	\begin{exampleblock}{Exercice}
		\begin{enumerate}
			\item<5-> Ecrire une fonction prenant en argument un flottant {\tt x} et un entier positif {\tt n} et qui renvoie {\tt x} puissance {\tt n}.
...
\begin{exampleblock}{Correction}
	...
	\begin{minipage}{0.5\textwidth}
		\inputpartC{/home/fenarius/Travail/Cours/cpge-info/docs/mp2i/files/C2/ex_puissance.c}{}{\small}{5}{10}
	\end{minipage} &
	sds
\end{tabularx}
\end{exampleblock}
