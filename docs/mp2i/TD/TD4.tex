...
\ModeExercice
\TD{2}{Arithmétique des ordinateurs}
...
\Question{Donner la valeur décimale des nombres suivants codé sous le format simple précision de la norme IEEE-754 :}
    ...
    \subQuestion{$\underbrace{1}_{\mathrm{signe}} \quad \underbrace{01111101}_{\mathrm{exposant\: décalé}} \quad \underbrace{01101100000000000000000}_{\mathrm{mantisse}}$}
