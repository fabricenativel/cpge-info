...
\begin{Exercise}[title = {Maximum des éléments d'un tableauœ}]
	\Question{Ecrire en C une fonction qui renvoie le maximum des éléments d'un tableau non vide. Par exemple pour le tableau {\tt \{2, 5, 4, 9, 7, 6\}}, la fonction renvoie {\tt 9}.}
