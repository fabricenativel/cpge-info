...
\Question{Ecrire une fonction {\tt hash  : string -> int} qui effectue la somme des carrés des code {\sc ascii} de la chaine donnée en argument}
\Question{Ecrire l'implémentation de l'algorithme de Rabin-Karp afin de recherche un motif dans un texte.}
