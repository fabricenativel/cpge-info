...
\Question{Ecrire une fonction {\tt hash  : string -> int} qui effectue la moyenne des code {\sc ascii} de la chaine donnée en argument en leur affectant pour coefficient leur position dans la chaine.}
\Question{Ecrire l'implémentation de l'algorithme de Rabin-Karp avec cette fonction de hachage afin de recherche un motif dans un texte.}
