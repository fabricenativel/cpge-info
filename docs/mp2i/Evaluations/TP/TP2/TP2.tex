...
\begin{Exercise}[title={Nombre  harshad}]
    ...
    \reponse{1}{1}
    \tcor{En utilisant les fonctions précédents, on trouve qu'il y a au maximum 5 nombres harshad consécutifs dans l'intervalle considéré, le premier d'entre eux est \numprint{131052}.}
\end{Exercise}
