...
\begin{Exercise}[title={Questions de cours}]
    ...
    \begin{tabularx}{\linewidth}{|>{\tt}p{7cm}|>{\tt}p{2cm}|X|}
        \hline
...
\subQuestion{Ecrire une fonction itérative {\tt occurrence} qui prend un argument une chaine de caractère {\tt texte} et une lettre {\tt l} et renvoie le nombre d'apparitions de {\tt l} dans {\tt texte}. Par exemple {\tt occurrence("ce petit exemple","t")} renvoie {\tt 2}.}
\ifcorrige
\corpartPython{majoritaire.py}{}{}{3}{10}
\fi
\subQuestion{Ecrire une version récursive de la fonction {\tt occurrence}}.
\ifcorrige
\corpartPython{majoritaire.py}{}{}{12}{19}
\fi
\subQuestion{Ecrire une fonction {\tt maximum} qui renvoie le maximum des éléments d'une liste non vide d'entiers.}
\ifcorrige
\corpartPython{majoritaire.py}{}{}{20}{25}
\fi
\subQuestion{En utilisant les fonction précédentes, écrire la fonction {\tt plusfrequentes} qui répond au problème posé.}
\ifcorrige
\corpartPython{majoritaire.py}{}{}{27}{34}
\fi
...
\tcor{La liste {\tt [2, 7]} est celle des chiffres de rang impair, et la liste {\tt [4, 6]} des chiffres de rang pair donne {\tt [8, 3]} ce qui conduit à une somme totale de {\tt 2+7+8+3 = 20} et donc un numéro valide.}
...
\ifcorrige
\corpartPython{luhn.py}{}{}{1}{5}
\fi
\Question{Ecrire une fonction {\tt pairs\_impairs} qui prend en argument une liste {\tt l} et renvoie deux listes, celles des éléments d'indice impair de {\tt l} et celle  éléments d'indice pairs en numérotant les indices à partir de la droite. Par exemple {\tt pairs\_impairs([4, 7, 6, 2])} renvoie {\tt [4, 6]} et {\tt [7, 2]}}
\ifcorrige
\corpartPython{luhn.py}{}{}{7}{17}
\fi
