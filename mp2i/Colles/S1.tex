...
\begin{Exercise}[title = {Suite de Golomb}]
    ...
    \Question{La suite de Golomb (du nom du mathématicien S. Golomb (1932--2016)), est la suite \textit{croissante} d'entiers $(g_n)_{n \in \N^*}$ telle que $g_1=1$, $g_2=2$ et $g_n$ est le nombre d'apparitions de $n$ dans $(g_n)_{n \in \N^*}$.}
