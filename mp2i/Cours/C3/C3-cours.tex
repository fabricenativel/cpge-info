...
\begin{frame}[fragile]{\Ctitle}{\stitle}
	\begin{exampleblock}{Quelques exemples}
		...
		Le pointeur \kw{ptr1}, est \textit{non itinialisé}, le déréfencer, par exemple pour lui attribuer une valeur (avec \mintinline{c}{*ptr1=42;}) est un comportement indéfini.
		\item<2-> Pointeur initialisé à {\sc null}
		\inputpartC{\SPATH/exmalloc.c}{}{\footnotesize}{7}{7}
		Le pointeur \kw{ptr2}, est itinialisé à {\sc null}, son déréférencement est un comportement indéfini. 
...
\begin{frame}[fragile]{\Ctitle}{\stitle}
	\begin{block}{Conséquences}
		En C, on n'écrira pas \textit{à proprement parlé} de fonctions renvoyant un tableau, mais plutôt des fonctions renvoyant un pointeur vers un bloc mémoire alloué dynamiquement que l'on traitera \textit{comme un tableau}. \\
