...
\begin{frame}{\Ctitle}{\stitle}
	\begin{block}{Remarque}
		Pour les algorithmes n'ayant pas de boucles, on peut prouver la correction d'un algorithme simplement en écrivant l'évolution des variables au cours du temps (à l'aide d'un tableau).
	\end{block}
	\onslide<2->{
	\begin{exampleblock}{Exemple}
		On considère la suite d'affectations :
		\inputpartC{\SPATH echange.c}{}{\small}{14}{16}
		\begin{itemize}
			\item Prouver que ces affectations échangent les valeurs de {\tt a} et {\tt b}.
			\item Quel est l'intérêt de cette suite d'affectation par rapport à l'utilisation d'une variable temporaire afin d'effectuer l'échange ? 
			\item En C, cette suite d'affectations peut-elle poser problème ?
		\end{itemize}
	\end{exampleblock}}
\end{frame}
