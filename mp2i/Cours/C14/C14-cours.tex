...
\begin{frame}[fragile]{\Ctitle}{\stitle}
	\begin{exampleblock}{Exemple}
		On considère la fonction {\tt f} définie en OCaml par :
		\inputpartOCaml{\SPATH/ex_intro.ml}{}{}{1}{5}
		\begin{enumerate}
			\item Donner les valeurs successives prises par {\tt a} et {\tt b} lors de l'évaluation de {\tt f 4 2}.
			\item Montrer la terminaison de cette fonction en utilisant la quantité $a^2+b$ comme variant.
		\end{enumerate}
	\end{exampleblock}
\end{frame}
