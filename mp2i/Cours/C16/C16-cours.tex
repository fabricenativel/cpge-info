...
\begin{frame}{\Ctitle}{\stitle}
	\begin{alertblock}{Définition}
		Soit  un ensemble au plus dénombrable de variables logiques noté $V = \{p, q, r, \dots \}$. On définit inductivement l'ensemble $P$ des formules logiques sur  $V$ par :
		\begin{itemize}
			...
			\item<4-> Les règles d'inférence :
				...
				\end{itemize}
		\end{itemize}
		\onslide<9->{On notera avec les lettres minuscules $p$, $q$, \dots \textit{les variables logiques} ie les éléments de  $
		V$ et avec les lettres majuscules  $F$, $G$, \dots \textit{les formules logiques} ie les éléments de $P$.}
	\end{alertblock}
\end{frame}
...
\begin{frame}{\Ctitle}{\stitle}
	\begin{block}{Remarques}
		\begin{itemize}
			...
			\item<7-> On a définit pour le moment simplement les formules logiques valables d'un point de vue \textit{syntaxique}, sans leur donner de sens ou de valeur.
		\end{itemize}
	\end{block}
	\onslide<8->{
...
\begin{frame}{\Ctitle}{\stitle}
	\begin{block}{Hauteur, taille et sous formule}
		Etant donnée une formule logique notée  $F$,
		\begin{itemize}
			\item<2-> la \textcolor{blue}{hauteur} de  $F$ est la hauteur de l'arbre syntaxique associé
			\item<3-> la \textcolor{blue}{taille} de  $F$ est le nombre de noeuds de l'arbre syntaxiqué associé
			\item<4-> Une \textcolor{blue}{sous formule} de  $F$ est un sous-arbre de l'arbre syntaxique associé
		\end{itemize}
	\end{block}
\end{frame}
...
\begin{frame}{\Ctitle}{\stitle}
	\begin{alertblock}{Valuation}
		...
		Une \textcolor{blue}{valuation} est une attribution de l'une des deux valeurs de vérités à chaque variable propositionnelle. Une valuation $\varphi$ est une donc une application de  $V$ dans $B$.
	\end{alertblock}
	\onslide<2->{
		\begin{exampleblock}{Exemple}
