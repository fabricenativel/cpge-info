...
\begin{Exercise*}[title = type A]\\
    ...
    \tcor{10 sur 7}
    \Question{Décompresser le texte $T$ codé par suite de codes {\tt [1; 2; 0; 3; 5; 4]} sur l'alphabet  {\tt \{a, b, l\}} avec les codes {\tt a} $\rightarrow 0$, {\tt b} $\rightarrow 1$ et {\tt l} $\rightarrow 2$ en expliquant comment est reconstruit le dictionnaire de décompression.}
    \tcor{$T = $ {\tt blablabla}}
