...
\begin{Exercise}[title={Ethnologie}, origin={\bac {\sc ccinp} 2017}]\\
    ...
    \end{itemize}
     ...
     \Question{Représenter les informations données par les participants sous la forme de deux formules du calcul des propostions $X_1$ et $Z_1$ dépendant des variables $V$ et $C$.}
