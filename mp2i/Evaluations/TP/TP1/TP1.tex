...
\begin{tabularx}{\linewidth}{|c|X|}
    ...
    {\tt cd ~} & \dotfill \\
    \hline
    \dotfill & Créer le répertoire {\tt exo1} \\
    \hline
    \dotfill & Créer le fichier vide  {\tt rep.txt} \\
    \hline
    {\tt chmod 640 rep.txt} & \dotfill \\
    \hline
    \dotfill & Ajouter le droit d'exécution pour l'utilisateur sur le fichier {\tt rep.txt} \\
    \hline
    \dotfill & Ecrire "Bonjour" dans le fichier {\tt rep.txt} \\
    \hline
    {\tt cp rep.txt \~{}/Sauvegardes} & \dotfill \\
    \hline
    \dotfill & Lister les fichiers (y compris les fichiers cachés) \\
    \hline
\end{tabularx}
\end{center}}
...
\subQuestion{A l'aide de la fonction précédente, calculer la somme des entiers strictement inférieurs à \numprint{10 000} et divisible par 3 ou 7 et donner la réponse trouvée par votre programme: \fbox{\makebox[3cm]{\dotfill}}}
\Question{Manipulation de tableaux}
\subQuestion{Ecrire dans le fichier {\tt ex2\_question2.c} une fonction {\tt etendue} qui prend en argument un tableau  et sa taille et renvoie l'écart maximal entre deux éléments de ce tableau. Par exemple, sur le tableau {\tt int ex[7] = \{1, 5, 3, 0, -1, 4, 8 \}}, la fonction {\tt etendue} doit renvoyer {\tt 9}.}
...
\subQuestion{Déterminer l'écart maximal entre deux éléments du tableau {\tt tab} défini à la question précédente et donner la réponse trouvée par votre programme : \fbox{\makebox[3cm]{\dotfill}}}
