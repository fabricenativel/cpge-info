...
Les capacités sur les manipulations de listes chainées sont aussi à consolider.
}
\end{tabularx}
\medskip
    ...
    \hline
    {Base d'OCaml (fonctionnel)} & 40\% \;{\small (34/85)} & 100\% \;{\small (11/11)} \\ \hline {Types structurés en C et pointeurs} & 28\% \;{\small (13/45)} & 100\% \;{\small (4/4)} \\ \hline {Structure de données séquentielles} & 100\% \;{\small (05/5)} & 100\% \;{\small (1/1)} \\ \hline {Programmation de base en C} & 24\% \;{\small (06/25)} & 75\% \;{\small (3/4)} \\ \hline {Comprendre un algorithme} & 90\% \;{\small (09/10)} & 100\% \;{\small (2/2)} \\ \hline {Complexité d'un algorithme} & 86\% \;{\small (52/60)} & 100\% \;{\small (8/8)} \\ \hline \end{tabular} \\\\\medskip \\
...
\medskip
    ...
    \multicolumn{1}{l|}{} & \multicolumn{1}{|c|}{Points} & \multicolumn{1}{|c|}{Traitées} \\
    \hline
    {Base d'OCaml (fonctionnel)} & 71\% \;{\small (61/85)} & 81\% \;{\small (9/11)} \\ \hline {Types structurés en C et pointeurs} & 64\% \;{\small (29/45)} & 100\% \;{\small (4/4)} \\ \hline {Structure de données séquentielles} & 100\% \;{\small (05/5)} & 100\% \;{\small (1/1)} \\ \hline {Programmation de base en C} & 96\% \;{\small (24/25)} & 100\% \;{\small (4/4)} \\ \hline {Comprendre un algorithme} & 100\% \;{\small (10/10)} & 100\% \;{\small (2/2)} \\ \hline {Complexité d'un algorithme} & 100\% \;{\small (60/60)} & 100\% \;{\small (8/8)} \\ \hline \end{tabular} \\\\\medskip \\
    \ding{113} \textbf{\sffamily{Résultats par exercice}} \medskip \\
    \renewcommand{\arraystretch}{1.2}
    \begin{tabular}{|l|r|r|}
    \cline{2-3}
...
\alertbox{\faComment}{Commentaire}
{
	Excellent travail. Dans la fonction qui renvoie la longueur d’une liste, on ne peut pas utiliser la fonction retirer.
}
\end{tabularx}
\medskip
    \ding{113} \textbf{\sffamily{Résultats par thème}} \medskip \\
    ...
    \multicolumn{1}{l|}{} & \multicolumn{1}{|c|}{Points} & \multicolumn{1}{|c|}{Traitées} \\
    \hline
    {Base d'OCaml (fonctionnel)} & 100\% \;{\small (85/85)} & 100\% \;{\small (11/11)} \\ \hline {Types structurés en C et pointeurs} & 80\% \;{\small (36/45)} & 100\% \;{\small (4/4)} \\ \hline {Structure de données séquentielles} & 100\% \;{\small (05/5)} & 100\% \;{\small (1/1)} \\ \hline {Programmation de base en C} & 100\% \;{\small (25/25)} & 100\% \;{\small (4/4)} \\ \hline {Comprendre un algorithme} & 100\% \;{\small (10/10)} & 100\% \;{\small (2/2)} \\ \hline {Complexité d'un algorithme} & 100\% \;{\small (60/60)} & 100\% \;{\small (8/8)} \\ \hline \end{tabular} \\\\\medskip \\
    \ding{113} \textbf{\sffamily{Résultats par exercice}} \medskip \\
    \renewcommand{\arraystretch}{1.2}
    \begin{tabular}{|l|r|r|}
    \cline{2-3}
...
\medskip
    ...
    \multicolumn{1}{l|}{} & \multicolumn{1}{|c|}{Points} & \multicolumn{1}{|c|}{Traitées} \\
    \hline
    {Base d'OCaml (fonctionnel)} & 29\% \;{\small (25/85)} & 81\% \;{\small (9/11)} \\ \hline {Types structurés en C et pointeurs} & 11\% \;{\small (05/45)} & 50\% \;{\small (2/4)} \\ \hline {Structure de données séquentielles} & 60\% \;{\small (03/5)} & 100\% \;{\small (1/1)} \\ \hline {Programmation de base en C} & 40\% \;{\small (10/25)} & 75\% \;{\small (3/4)} \\ \hline {Comprendre un algorithme} & 100\% \;{\small (10/10)} & 100\% \;{\small (2/2)} \\ \hline {Complexité d'un algorithme} & 65\% \;{\small (39/60)} & 100\% \;{\small (8/8)} \\ \hline \end{tabular} \\\\\medskip \\
    \ding{113} \textbf{\sffamily{Résultats par exercice}} \medskip \\
    \renewcommand{\arraystretch}{1.2}
    \begin{tabular}{|l|r|r|}
    \cline{2-3}
...
\alertbox{\faComment}{Commentaire}
{
	Il y a de bonnes choses mais tu n’as pas traité suffisamment de question pour atteindre la moyenne. Il faut mieux gérer le temps ! Les listes chainées en C sont aussi à retravailler.
}
\end{tabularx}
\medskip
    \ding{113} \textbf{\sffamily{Résultats par thème}} \medskip \\
    ...
    \multicolumn{1}{l|}{} & \multicolumn{1}{|c|}{Points} & \multicolumn{1}{|c|}{Traitées} \\
    \hline
    {Base d'OCaml (fonctionnel)} & 23\% \;{\small (20/85)} & 18\% \;{\small (2/11)} \\ \hline {Types structurés en C et pointeurs} & 48\% \;{\small (22/45)} & 75\% \;{\small (3/4)} \\ \hline {Structure de données séquentielles} & 100\% \;{\small (05/5)} & 100\% \;{\small (1/1)} \\ \hline {Programmation de base en C} & 40\% \;{\small (10/25)} & 50\% \;{\small (2/4)} \\ \hline {Comprendre un algorithme} & 90\% \;{\small (09/10)} & 100\% \;{\small (2/2)} \\ \hline {Complexité d'un algorithme} & 45\% \;{\small (27/60)} & 62\% \;{\small (5/8)} \\ \hline \end{tabular} \\\\\medskip \\
    \ding{113} \textbf{\sffamily{Résultats par exercice}} \medskip \\
    \renewcommand{\arraystretch}{1.2}
    \begin{tabular}{|l|r|r|}
    \cline{2-3}
...
\medskip
    ...
    \multicolumn{1}{l|}{} & \multicolumn{1}{|c|}{Points} & \multicolumn{1}{|c|}{Traitées} \\
    \hline
    {Base d'OCaml (fonctionnel)} & 8\% \;{\small (07/85)} & 54\% \;{\small (6/11)} \\ \hline {Types structurés en C et pointeurs} & 42\% \;{\small (19/45)} & 75\% \;{\small (3/4)} \\ \hline {Structure de données séquentielles} & 0\% \;{\small (00/5)} & 100\% \;{\small (1/1)} \\ \hline {Programmation de base en C} & 8\% \;{\small (02/25)} & 50\% \;{\small (2/4)} \\ \hline {Comprendre un algorithme} & 40\% \;{\small (04/10)} & 100\% \;{\small (2/2)} \\ \hline {Complexité d'un algorithme} & 38\% \;{\small (23/60)} & 50\% \;{\small (4/8)} \\ \hline \end{tabular} \\\\\medskip \\
    \ding{113} \textbf{\sffamily{Résultats par exercice}} \medskip \\
    \renewcommand{\arraystretch}{1.2}
    \begin{tabular}{|l|r|r|}
    \cline{2-3}
...
\medskip
    ...
    \multicolumn{1}{l|}{} & \multicolumn{1}{|c|}{Points} & \multicolumn{1}{|c|}{Traitées} \\
    \hline
    {Base d'OCaml (fonctionnel)} & 21\% \;{\small (18/85)} & 45\% \;{\small (5/11)} \\ \hline {Types structurés en C et pointeurs} & 6\% \;{\small (03/45)} & 50\% \;{\small (2/4)} \\ \hline {Structure de données séquentielles} & 100\% \;{\small (05/5)} & 100\% \;{\small (1/1)} \\ \hline {Programmation de base en C} & 40\% \;{\small (10/25)} & 50\% \;{\small (2/4)} \\ \hline {Comprendre un algorithme} & 100\% \;{\small (10/10)} & 100\% \;{\small (2/2)} \\ \hline {Complexité d'un algorithme} & 50\% \;{\small (30/60)} & 50\% \;{\small (4/8)} \\ \hline \end{tabular} \\\\\medskip \\
    \ding{113} \textbf{\sffamily{Résultats par exercice}} \medskip \\
    \renewcommand{\arraystretch}{1.2}
    \begin{tabular}{|l|r|r|}
    \cline{2-3}
...
\medskip
    ...
    \multicolumn{1}{l|}{} & \multicolumn{1}{|c|}{Points} & \multicolumn{1}{|c|}{Traitées} \\
    \hline
    {Base d'OCaml (fonctionnel)} & 4\% \;{\small (04/85)} & 36\% \;{\small (4/11)} \\ \hline {Types structurés en C et pointeurs} & 0\% \;{\small (00/45)} & 25\% \;{\small (1/4)} \\ \hline {Structure de données séquentielles} & 0\% \;{\small (00/5)} & 0\% \;{\small (0/1)} \\ \hline {Programmation de base en C} & 4\% \;{\small (01/25)} & 50\% \;{\small (2/4)} \\ \hline {Comprendre un algorithme} & 40\% \;{\small (04/10)} & 100\% \;{\small (2/2)} \\ \hline {Complexité d'un algorithme} & 1\% \;{\small (01/60)} & 25\% \;{\small (2/8)} \\ \hline \end{tabular} \\\\\medskip \\
    \ding{113} \textbf{\sffamily{Résultats par exercice}} \medskip \\
    \renewcommand{\arraystretch}{1.2}
    \begin{tabular}{|l|r|r|}
    \cline{2-3}
...
\medskip
    ...
    \multicolumn{1}{l|}{} & \multicolumn{1}{|c|}{Points} & \multicolumn{1}{|c|}{Traitées} \\
    \hline
    {Base d'OCaml (fonctionnel)} & 20\% \;{\small (17/85)} & 63\% \;{\small (7/11)} \\ \hline {Types structurés en C et pointeurs} & 55\% \;{\small (25/45)} & 75\% \;{\small (3/4)} \\ \hline {Structure de données séquentielles} & 100\% \;{\small (05/5)} & 100\% \;{\small (1/1)} \\ \hline {Programmation de base en C} & 40\% \;{\small (10/25)} & 50\% \;{\small (2/4)} \\ \hline {Comprendre un algorithme} & 90\% \;{\small (09/10)} & 100\% \;{\small (2/2)} \\ \hline {Complexité d'un algorithme} & 33\% \;{\small (20/60)} & 37\% \;{\small (3/8)} \\ \hline \end{tabular} \\\\\medskip \\
    \ding{113} \textbf{\sffamily{Résultats par exercice}} \medskip \\
    \renewcommand{\arraystretch}{1.2}
    \begin{tabular}{|l|r|r|}
    \cline{2-3}
...
\medskip
    ...
    \multicolumn{1}{l|}{} & \multicolumn{1}{|c|}{Points} & \multicolumn{1}{|c|}{Traitées} \\
    \hline
    {Base d'OCaml (fonctionnel)} & 69\% \;{\small (59/85)} & 72\% \;{\small (8/11)} \\ \hline {Types structurés en C et pointeurs} & 75\% \;{\small (34/45)} & 100\% \;{\small (4/4)} \\ \hline {Structure de données séquentielles} & 100\% \;{\small (05/5)} & 100\% \;{\small (1/1)} \\ \hline {Programmation de base en C} & 60\% \;{\small (15/25)} & 100\% \;{\small (4/4)} \\ \hline {Comprendre un algorithme} & 90\% \;{\small (09/10)} & 100\% \;{\small (2/2)} \\ \hline {Complexité d'un algorithme} & 80\% \;{\small (48/60)} & 87\% \;{\small (7/8)} \\ \hline \end{tabular} \\\\\medskip \\
    \ding{113} \textbf{\sffamily{Résultats par exercice}} \medskip \\
    \renewcommand{\arraystretch}{1.2}
    \begin{tabular}{|l|r|r|}
    \cline{2-3}
...
\medskip
    ...
    \multicolumn{1}{l|}{} & \multicolumn{1}{|c|}{Points} & \multicolumn{1}{|c|}{Traitées} \\
    \hline
    {Base d'OCaml (fonctionnel)} & 75\% \;{\small (64/85)} & 100\% \;{\small (11/11)} \\ \hline {Types structurés en C et pointeurs} & 80\% \;{\small (36/45)} & 100\% \;{\small (4/4)} \\ \hline {Structure de données séquentielles} & 100\% \;{\small (05/5)} & 100\% \;{\small (1/1)} \\ \hline {Programmation de base en C} & 68\% \;{\small (17/25)} & 100\% \;{\small (4/4)} \\ \hline {Comprendre un algorithme} & 100\% \;{\small (10/10)} & 100\% \;{\small (2/2)} \\ \hline {Complexité d'un algorithme} & 95\% \;{\small (57/60)} & 100\% \;{\small (8/8)} \\ \hline \end{tabular} \\\\\medskip \\
    \ding{113} \textbf{\sffamily{Résultats par exercice}} \medskip \\
    \renewcommand{\arraystretch}{1.2}
    \begin{tabular}{|l|r|r|}
    \cline{2-3}
...
\medskip
    ...
    \multicolumn{1}{l|}{} & \multicolumn{1}{|c|}{Points} & \multicolumn{1}{|c|}{Traitées} \\
    \hline
    {Base d'OCaml (fonctionnel)} & 75\% \;{\small (64/85)} & 81\% \;{\small (9/11)} \\ \hline {Types structurés en C et pointeurs} & 48\% \;{\small (22/45)} & 100\% \;{\small (4/4)} \\ \hline {Structure de données séquentielles} & 80\% \;{\small (04/5)} & 100\% \;{\small (1/1)} \\ \hline {Programmation de base en C} & 60\% \;{\small (15/25)} & 75\% \;{\small (3/4)} \\ \hline {Comprendre un algorithme} & 100\% \;{\small (10/10)} & 100\% \;{\small (2/2)} \\ \hline {Complexité d'un algorithme} & 68\% \;{\small (41/60)} & 100\% \;{\small (8/8)} \\ \hline \end{tabular} \\\\\medskip \\
    \ding{113} \textbf{\sffamily{Résultats par exercice}} \medskip \\
    \renewcommand{\arraystretch}{1.2}
    \begin{tabular}{|l|r|r|}
    \cline{2-3}
...
\medskip
    ...
    \multicolumn{1}{l|}{} & \multicolumn{1}{|c|}{Points} & \multicolumn{1}{|c|}{Traitées} \\
    \hline
    {Base d'OCaml (fonctionnel)} & 12\% \;{\small (11/85)} & 54\% \;{\small (6/11)} \\ \hline {Types structurés en C et pointeurs} & 24\% \;{\small (11/45)} & 100\% \;{\small (4/4)} \\ \hline {Structure de données séquentielles} & 100\% \;{\small (05/5)} & 100\% \;{\small (1/1)} \\ \hline {Programmation de base en C} & 56\% \;{\small (14/25)} & 75\% \;{\small (3/4)} \\ \hline {Comprendre un algorithme} & 100\% \;{\small (10/10)} & 100\% \;{\small (2/2)} \\ \hline {Complexité d'un algorithme} & 50\% \;{\small (30/60)} & 62\% \;{\small (5/8)} \\ \hline \end{tabular} \\\\\medskip \\
    \ding{113} \textbf{\sffamily{Résultats par exercice}} \medskip \\
    \renewcommand{\arraystretch}{1.2}
    \begin{tabular}{|l|r|r|}
    \cline{2-3}
...
\medskip
    ...
    \multicolumn{1}{l|}{} & \multicolumn{1}{|c|}{Points} & \multicolumn{1}{|c|}{Traitées} \\
    \hline
    {Base d'OCaml (fonctionnel)} & 44\% \;{\small (38/85)} & 100\% \;{\small (11/11)} \\ \hline {Types structurés en C et pointeurs} & 13\% \;{\small (06/45)} & 25\% \;{\small (1/4)} \\ \hline {Structure de données séquentielles} & 100\% \;{\small (05/5)} & 100\% \;{\small (1/1)} \\ \hline {Programmation de base en C} & 40\% \;{\small (10/25)} & 50\% \;{\small (2/4)} \\ \hline {Comprendre un algorithme} & 100\% \;{\small (10/10)} & 100\% \;{\small (2/2)} \\ \hline {Complexité d'un algorithme} & 56\% \;{\small (34/60)} & 75\% \;{\small (6/8)} \\ \hline \end{tabular} \\\\\medskip \\
    \ding{113} \textbf{\sffamily{Résultats par exercice}} \medskip \\
    \renewcommand{\arraystretch}{1.2}
    \begin{tabular}{|l|r|r|}
    \cline{2-3}
