...
\begin{frame}{\Ctitle}{\stitle}
	\begin{exampleblock}{Correction question 1}
		\inputpython{/home/fenarius/Travail/Cours/cpge-info/docs/itc/files/C18/plus_frequent1.py}{}{\footnotesize}
	\end{exampleblock}
\end{frame}

\begin{frame}{\Ctitle}{\stitle}
	\begin{exampleblock}{Correction question 2}
		\inputpython{/home/fenarius/Travail/Cours/cpge-info/docs/itc/files/C18/plus_frequent2.py}{}{\footnotesize}
	\end{exampleblock}
\end{frame}
...
rss
		...
		\begin{enumerate}
			\item Proposer une version utilisant une liste  \kw{deja\_vu} dans laquelle on enregistre au fur et à mesure du parcours les chaines de caractères déjà rencontrées.
...
\begin{frame}{\Ctitle}{\stitle}
	\begin{exampleblock}{Correction question 1}
		\inputpython{/home/fenarius/Travail/Cours/cpge-info/docs/itc/files/C18/fibo_rec.py}{}{\footnotesize}
	\end{exampleblock}
\end{frame}
...
\begin{frame}[fragile]{\Ctitle}{\stitle}
	\begin{exampleblock}{Fibonnaci avec mémoïsation}
		\inputpython{/home/fenarius/Travail/Cours/cpge-info/docs/itc/files/C18/fibo_rec_memo.py}{}{\footnotesize}
	\end{exampleblock}
\end{frame}
...
\begin{frame}[fragile]{\Ctitle}{\stitle}
	...
	\onslide<2->{
		\begin{exampleblock}{Fibonacci mémoïsation automatique}
			\inputpython{/home/fenarius/Travail/Cours/cpge-info/docs/itc/files/C18/fibo_rec_memo2.py}{}{\footnotesize}
		\end{exampleblock}}
\end{frame}
	...
	\begin{exampleblock}{Résolution}
		\begin{enumerate}
			...
			\item<3-> \textcolor{OliveGreen}{Programme Python :}
				\inputpython{/home/fenarius/Travail/Cours/cpge-info/docs/itc/files/C18/decoupe.py}{}{\scriptsize}
...
\begin{frame}{\Ctitle}{\stitle}
	\begin{exampleblock}{Version avec mémoïsation}
		\inputpython{/home/fenarius/Travail/Cours/cpge-info/docs/itc/files/C18/decoupe_memo.py}{}{\scriptsize}
	\end{exampleblock}
\end{frame}
...
\begin{frame}{\Ctitle}{\stitle}
	\begin{exampleblock}{Calcul de bas en haut (\textit{bottom up})}
		...
		\onslide<4->{\inputpython{/home/fenarius/Travail/Cours/cpge-info/docs/itc/files/C18/decoupe_iter.py}{}{\footnotesize}}
	\end{exampleblock}
\end{frame}
...
\begin{frame}{\Ctitle}{\stitle}
	\begin{exampleblock}{Programme Python pour plssc}
		{\inputpartPython{/home/fenarius/Travail/Cours/cpge-info/docs/itc/files/C18/plssc.py}{}{\footnotesize}{1}{9}}
	\end{exampleblock}
\end{frame}
...
\begin{frame}{\Ctitle}{\stitle}
	\begin{exampleblock}{Construction effective d'une solution}
		...
		\end{itemize}
		\onslide<3->{\inputpartPython{/home/fenarius/Travail/Cours/cpge-info/docs/itc/files/C18/plssc.py}{}{\footnotesize}{13}{22}}
	\end{exampleblock}
\end{frame}
...
\makess{Exemple résolu : chemin de somme maximale dans une pyramide}
\begin{frame}{\Ctitle}{\stitle}
	\begin{exampleblock}{Position du problème}
		...
		\begin{center}
				\begin{pspicture}(0,-2.2)(6,0.5) % Ajuster la taille de la figure selon les besoins
				  % Niveau 1
				  \rput(3,0){\psframebox[framesep=4pt]{\alt<6->{\textcolor{BrickRed}{\bf 5}}{5}}}
				  % Niveau 2
				  \rput(2.5,-0.52){\psframebox[framesep=4pt]{\alt<6->{\textcolor{BrickRed}{\bf 3}}{3}}}
				  \rput(3.5,-0.52){\psframebox[framesep=4pt]{4}}
				  % Niveau 3
				  \rput(2,-1.04){\psframebox[framesep=4pt]{\alt<6->{\textcolor{BrickRed}{\bf 9}}{9}}}
				  \rput(3,-1.04){\psframebox[framesep=4pt]{2}}
				  \rput(4,-1.04){\psframebox[framesep=4pt]{6}}
				  % Niveau 4
				  \rput(1.5,-1.56){\psframebox[framesep=4pt]{4}}
				  \rput(2.5,-1.56){\psframebox[framesep=4pt]{\alt<6->{\textcolor{BrickRed}{\bf 6}}{6}}}
				  \rput(3.5,-1.56){\psframebox[framesep=4pt]{8}}
				  \rput(4.5,-1.56){\psframebox[framesep=4pt]{4}}
				  % Niveau 5
				  \rput(1,-2.08){\psframebox[framesep=4pt]{3}}
				  \rput(2,-2.08){\psframebox[framesep=4pt]{\alt<6->{\textcolor{BrickRed}{\bf 9}}{9}}}
...
\begin{frame}{\Ctitle}{\stitle}
	\begin{exampleblock}{Position du problème}
		\begin{center}
				\begin{pspicture}(0,-2.7)(6,0.5) % Ajuster la taille de la figure selon les besoins
				  % Niveau 1
				  \rput(3,0){\psframebox[framesep=4pt]{5}}
				  % Niveau 2
				  \rput(2.5,-0.52){\psframebox[framesep=4pt]{3}}
				  \rput(3.5,-0.52){\psframebox[framesep=4pt]{4}}
				  % Niveau 3
				  \rput(2,-1.04){\psframebox[framesep=4pt]{9}}
...
\begin{frame}{\Ctitle}{\stitle}
\begin{exampleblock}{Eléments de résolution}
	\begin{itemize}
		\item<1-> On représente la pyramide de façon matricielle par une liste de liste. Par exemple la pyramide ci-dessous est la liste : \mintinline{python}{[[5], [3, 4], [9, 2, 6], [4, 6, 8, 4], [3, 9, 2, 5, 7]]}. On note $p_{i,j}$ le coefficient de cette matrice situé en ligne $i$ et en colonne $j$. 
		\item<2-> Toute sous pyramide est alors identifiée par les indices de ligne et de colonne de son sommet dans cette liste. Par exemple le sommet de la pyramide initial est {\tt (0,0)}.
		\item<3-> D'après l'étude qui précède en notant $M_{i,j}$ la somme d'un chemin maximal pour la pyramide de sommet $(i,j)$, on obtient immédiatement l'équation suivante :
		\textcolor{blue}{$M_{i,j} = p_{i,j} + \max \left\{M_{i+1,j} \, ; \,  M_{i+1,j+1} \right\}$.}
		\item<4-> Le cas de base est lorsque $i=n-1$ (on atteint la base de la pyramide).
		\item<5-> Voir l'exercice de TP pour une résolution complète.
	\end{itemize}
	...
	\begin{exampleblock}{Résolution}
		\begin{enumerate}
			...
			\item Programme Python (avec mémoïsation dans le dictionnaire \kw{memo})
			      {\inputpartPython{/home/fenarius/Travail/Cours/cpge-info/docs/itc/files/C18/rm.py}{}{\footnotesize}{3}{13}}
		\end{enumerate}
	\end{exampleblock}
\end{frame}
	...
	\begin{exampleblock}{Résolution}
		\begin{enumerate}
			...
			\item Cette méthode correspond au programme suivant :
			      {\inputpartPython{/home/fenarius/Travail/Cours/cpge-info/docs/itc/files/C18/rm.py}{}{\footnotesize}{15}{26}}
		\end{enumerate}
	\end{exampleblock}
\end{frame}
