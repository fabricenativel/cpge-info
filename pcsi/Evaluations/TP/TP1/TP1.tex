...
\begin{Exercise}[title={Calculer une somme}]
	\Question{Ecrire en Python, une fonction {\tt somme} qui prend en entrée un entier {\tt n} et calcule la somme des entiers de 1 à {\tt n} qui se terminent par 3 et sont divisibles par 7. Par exemple, {\tt somme(100)}} doit renvoyer {\tt 196} car {\tt 63} et {\tt 133} sont les seul entier entre 1 et 200 se terminant par 3 et divisible par 7 et leur somme vaut {\tt 196}.
	\reponse{6}{2}
    \ifcorrige 
...
\begin{Exercise}[title={Chaine de caractères}]
	...
	\begin{itemize}
	\item {\tt occurrence("mercredi","e")} renvoie 2 puisqu'il y la lettre {\tt e} apparaît deux fois dans {\tt mercredi},
