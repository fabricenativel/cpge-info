...
\newcommand{\inputOCaml}[3]{\begin{mdframed}[backgroundcolor=codebg] \inputminted[breaklines=true,fontsize=#3,linenos=true,highlightcolor=fluo,tabsize=2,highlightlines={#2}]{ocaml}{#1} \end{mdframed}}
...
\newcommand{\ipp}[3]{\begin{mdframed}[backgroundcolor=codebg] \inputminted[breaklines=true,linenos=false,firstline=#2,lastline=#3,firstnumber=1]{python}{#1} \end{mdframed}}
\newcommand{\inputpartC}[5]{\begin{mdframed}[backgroundcolor=codebg] \inputminted[breaklines=true,fontsize=#3,linenos=true,highlightcolor=fluo,tabsize=2,highlightlines={#2},firstline=#4,lastline=#5,firstnumber=1]{c}{#1} \end{mdframed}}
\newcommand{\corC}[3]{\begin{mdframed}[backgroundcolor=white,linecolor=OliveGreen,linewidth=1pt] \inputminted[breaklines=true,fontsize=#3,linenos=true,highlightcolor=fluo,tabsize=2,highlightlines={#2}firstnumber=1]{c}{#1} \end{mdframed}}
\newcommand{\corOCaml}[3]{\begin{mdframed}[backgroundcolor=white,linecolor=OliveGreen,linewidth=1pt] \inputminted[breaklines=true,fontsize=#3,linenos=true,highlightcolor=fluo,tabsize=2,highlightlines={#2},firstnumber=1]{OCaml}{#1} \end{mdframed}}

\newcommand{\corpartC}[5]{\begin{mdframed}[backgroundcolor=white,linecolor=OliveGreen,linewidth=1pt] \inputminted[breaklines=true,fontsize=#3,linenos=true,highlightcolor=fluo,tabsize=2,highlightlines={#2},firstline=#4,lastline=#5,firstnumber=1]{c}{#1} \end{mdframed}}
\newcommand{\corpartOCaml}[5]{\begin{mdframed}[backgroundcolor=white,linecolor=OliveGreen,linewidth=1pt] \inputminted[breaklines=true,fontsize=#3,linenos=true,highlightcolor=fluo,tabsize=2,highlightlines={#2},firstline=#4,lastline=#5,firstnumber=1]{OCaml}{#1} \end{mdframed}}
\newcommand{\corpartPython}[5]{\begin{mdframed}[backgroundcolor=white,linecolor=OliveGreen,linewidth=1pt] \inputminted[breaklines=true,fontsize=#3,linenos=true,highlightcolor=fluo,tabsize=2,highlightlines={#2},firstline=#4,lastline=#5,firstnumber=1]{python}{#1} \end{mdframed}}
\newcommand{\corpartSQL}[5]{\begin{mdframed}[backgroundcolor=white,linecolor=OliveGreen,linewidth=1pt] \inputminted[breaklines=true,fontsize=#3,linenos=true,highlightcolor=fluo,tabsize=2,highlightlines={#2},firstline=#4,lastline=#5,firstnumber=1]{sql}{#1} \end{mdframed}}
...
% Case choix qcm
\newcommand{\ch}{\ding{109}}
\newcommand{\gc}{\ifthenelse{\boolean{corrige}}{\textcolor{OliveGreen}{\faCheckCircle\,}}{\faCircle[regular]\,}}
\newcommand{\bc}{\ifthenelse{\boolean{corrige}}{\textcolor{BrickRed}{\faCircle[regular]\,}}{\faCircle[regular]\,}}

%Macro d'affichage d'une question à choix multiple
\NewDocumentCommand{\qcm}{ m m }
 {
   % affichage de l'énoncé
   \textbf{Question :}~#1

   % création de la liste à cocher
   \begin{itemize}[label=$\square$] % cases vides devant chaque choix
...
\newcommand{\scor}[1]{\par \textcolor{OliveGreen}{\small #1}}
\newcommand{\cor}[1]{\par \textcolor{OliveGreen}{#1}}
\newcommand{\br}[1]{\cor{\textbf{#1}}}
\newcommand{\tcor}[1]{
\ifthenelse{\boolean{corrige}}{\begin{tcolorbox}[width=\linewidth,colback={white},coltext=OliveGreen,colbacktitle=white,coltitle=OliveGreen,colframe=OliveGreen,boxrule=0.2mm]   
#1
\end{tcolorbox}}{}
}
\newcommand{\iscor}[1]{\ifthenelse{\boolean{corrige}}{#1}}
\newcommand{\comp}[1]{\ifthenelse{\boolean{corrige}}{\cor{#1}}{\dots}}
...
\rhead{Niveau: \textbf{#2}}
\cfoot{}}
\newcommand{\RDS}[2]{\lhead{\textbf{Résultats du DS \no{}#1}}
\rhead{Date : \textbf{#2}}
\cfoot{}}
...
\end{center}}\cfoot{}}
% ICX{Type}{Numéro}{Filière}{Thème}{Barème}
\newcommand{\ICX}[5]{\lhead{\textbf{#1 n° #2}}
\rhead{{\sc #3 --} \textbf{#4}} \setlength{\fboxsep}{8pt}
\ifthenelse{\boolean{corrige}}{}
{\begin{center}
%Titre de la fiche
\fbox{\parbox[b][1cm][t]{0.3\textwidth}{Nom : \hfill \po{3} \par \vfill Prénom : \hfill \po{3}} } \hfill 
\fbox{\parbox[b][1cm][t]{0.6\textwidth}{Note : \po{1} / #5} }
\end{center}}\cfoot{}}
\newcommand{\ICP}[3]{\lhead{\textbf{Interro de cours n° #1}}
\rhead{{\sc #3 --} \textbf{#2}} \setlength{\fboxsep}{8pt}
\ifthenelse{\boolean{corrige}}{}
{\begin{center}
%Titre de la fiche
\fbox{\parbox[b][1cm][t]{0.3\textwidth}{Nom : \hfill \po{3} \par \vfill Prénom : \hfill \po{3}} } \hfill 
...
\newcommand{\CB}[2]{\lhead{{#1} : \textbf{Concours blanc - Informatique}}
...
\newtoks\tabtok
\newcommand*\reponse[2]{%
   \ifthenelse{\boolean{corrige}}{}{\leavevmode \newline
   \global\tabtok{\renewcommand{\arraystretch}{1.8}\begin{tabularx}{\linewidth}{|X|p{1cm}|}\hline \dotfill & \cellcolor{gray!30}{\small \dots/#2} \\ \cline{2-2}}%
   \multido{}{#1}{\gaddtotok{ \multicolumn{2}{|>{\hsize=\dimexpr1\hsize+2\tabcolsep+\arrayrulewidth+1cm\relax}X|}{\dotfill}\leavevmode\\}}%
   \gaddtotok{\hline \end{tabularx}}%
   \the\tabtok
   }}
\newcommand*\rep[1]{%
   \ifthenelse{\boolean{corrige}}{}{\leavevmode \newline
   \global\tabtok{\renewcommand{\arraystretch}{1.4}\begin{tabularx}{\linewidth}{|X|}\hline \dotfill \\}%
   \multido{}{#1}{\gaddtotok{{\dotfill}\leavevmode\\}}%
   \gaddtotok{\hline \end{tabularx}}%
   \the\tabtok
   }}
\newcommand{\points}[1]{\ifthenelse{\boolean{corrige}}{}{\hfill \renewcommand{\arraystretch}{1.4} \begin{tabular}{|l|} \hline \cellcolor{gray!30}{\small \dots/#1} \\ \hline \end{tabular}}}

\newcommand{\PE}[1]{\left \lfloor #1 \right \rfloor}

\newcommand{\NRet}{\setlength{\leftskip}{-\QuestionIndent}}
\newcommand{\Ret}{\setlength{\leftskip}{0pt}}