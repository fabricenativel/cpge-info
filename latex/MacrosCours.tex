...
\definecolor{hideblue}{rgb}{0.914,0.914,0.953}
\newminted[langageC]{c}{linenos=true,escapeinside=ùù,highlightcolor=fluo,tabsize=2,breaklines=true}
\newminted[OCaml]{ocaml}{linenos=true,escapeinside=||,highlightcolor=fluo,tabsize=2,breaklines=true}
...
\newcommand{\fn}[1]{\textcolor{darkgray}{\tt #1}}
\newcommand{\on}[1]{\textcolor{brown}{\tt #1}}
